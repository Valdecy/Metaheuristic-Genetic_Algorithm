...
ga = genetic_algorithm(population_size = 25, mutation_rate = 0.05, elite = 0, eta = 1, mu = 1, min_values = [-5,-5], max_values = [5,5], generations = 100, target_function = six_hump_camel_back)
...
ga = genetic_algorithm(population_size = 50, mutation_rate = 0.01, elite = 1, eta = 1,  mu = 1, min_values = [-5,-5,-5,-5], max_values = [5,5,5,5], generations = 5000, target_function = rosenbrocks_valley)
